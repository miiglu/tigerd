...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/tigerd/common/tigerdSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { TigerdSettingsState } from '../../../../../../../workbench/contrib/tigerd/common/tigerdSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/tigerd/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/tigerd/common/refreshModelService.js';
import { ITigerdSettingsService } from '../../../../../../../workbench/contrib/tigerd/common/tigerdSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/tigerd/browser/extensionTransferService.js'
...
import { IMetricsService } from '../../../../../../../workbench/contrib/tigerd/common/metricsService.js'
...
let settingsState: TigerdSettingsState
const settingsStateListeners: Set<(s: TigerdSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(ITigerdSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		tigerdCommandBarService: accessor.get(ITigerdCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, tigerdCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		tigerdCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		tigerdCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		ITigerdSettingsService: accessor.get(ITigerdSettingsService),
		...
		ITigerdModelService: accessor.get(ITigerdModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		ITigerdCommandBarService: accessor.get(ITigerdCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Tigerd useAccessor was called before _registerServices!`)
	}
