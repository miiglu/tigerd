...
import { TextAreaFns, TigerdInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, TigerdChatArea } from '../sidebar-tsx/SidebarChat.js';
import { TIGERD_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/tigerd/common/tigerdSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(TIGERD_CTRL_K_ACTION_ID)?.getLabel()
