...
import { TigerdCommandBarProps } from '../../../tigerdCommandBarService.js';
...
export const TigerdCommandBarMain = ({ uri, editor }: TigerdCommandBarProps) => {
	const isDark = useIsDark()

	return <div
		className={`@@void-scope ${isDark ? 'dark' : ''}`}
	>
		<TigerdCommandBar uri={uri} editor={editor} />
	</div>
}
...
export const TigerdCommandBar = ({ uri, editor }: TigerdCommandBarProps) => {
	...
	const tigerdModelService = accessor.get('ITigerdModelService')
