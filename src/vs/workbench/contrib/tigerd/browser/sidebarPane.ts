...
// const voidViewIcon = registerIcon('void-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the Tigerd chat view.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "Tigerd" (Ctrl + L)
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupTigerdSidebar';
	constructor(
