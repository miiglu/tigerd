...
import { VOID_TOGGLE_SETTINGS_ACTION_ID } from './tigerdSettingsPane.js';
...
registerAction2(class extends Action2 {
	constructor() {
		super({ id: VOID_OPEN_SIDEBAR_ACTION_ID, title: localize2('voidOpenSidebar', 'Tigerd: Open Sidebar'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: TIGERD_CTRL_L_ACTION_ID,
			f1: true,
			title: localize2('voidCmdL', 'Tigerd: Add Selection to Chat'),
			keybinding: {
