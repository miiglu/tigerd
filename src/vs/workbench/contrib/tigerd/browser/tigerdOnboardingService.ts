...
import { mountTigerdOnboarding } from './react/out/tigerd-onboarding/index.js'
...
export class OnboardingContribution extends Disposable implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.tigerdOnboarding';
	...
	private initialize(): void {
		...
		if (workbench) {
			...
			this.instantiationService.invokeFunction((accessor: ServicesAccessor) => {
				const result = mountTigerdOnboarding(onboardingContainer, accessor);
