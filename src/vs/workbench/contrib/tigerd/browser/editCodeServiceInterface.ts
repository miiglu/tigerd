...
import { Diff, DiffArea, TigerdFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getTigerdFileSnapshot(uri: URI): TigerdFileSnapshot;
	restoreTigerdFileSnapshot(uri: URI, snapshot: TigerdFileSnapshot): void;
}
